...
const pl = {
  ...
  'common.footer.greeting': 'Wesołych Świąt!',
  ...
  'common.step.indicator': 'Krok {current} z {total}',
} as const;
...
export const common: MessageCatalog<CommonKey> = {
  ...
  en: {
    ...
    'common.footer.greeting': 'Merry Christmas!',
    ...
    'common.step.indicator': 'Step {current} of {total}',
  },
};
