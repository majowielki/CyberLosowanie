...
const pl = {
  ...
  'auth.login.subtitle': 'Zaloguj się, aby wziąć udział w losowaniu.',
  'auth.login.submit': 'Zaloguj się',
  'auth.login.noAccount': 'Nie masz jeszcze konta?',
  ...
  'auth.register.subtitle': 'Załóż konto, aby dołączyć do losowania.',
...
export const auth: MessageCatalog<AuthKey> = {
  ...
  en: {
    ...
    'auth.login.subtitle': 'Sign in to take part in the draw.',
    ...
    'auth.register.subtitle': 'Create an account to join the draw.',
