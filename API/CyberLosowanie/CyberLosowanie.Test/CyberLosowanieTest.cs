...
namespace CyberLosowanie.Test
{
    public class ValidationServiceTests
    {
        ...
        [Fact]
        public async Task ValidateCyberekAssignmentAsync_WithWhitespaceUserName_ReturnsValidationError()
        {
            // Arrange
            var assignmentDto = new CyberekAssignmentDTO { CyberekId = 1 };
        ...
        [Fact]
        public async Task ValidateCyberekAssignmentAsync_WithNonExistentCyberek_ReturnsCyberekNotFoundError()
        {
            // Arrange
            var assignmentDto = new CyberekAssignmentDTO { CyberekId = 1 };
        ...
        [Fact]
        public async Task ValidateCyberekAssignmentAsync_WithRepositoryException_PropagatesException()
        {
            // Arrange
            var assignmentDto = new CyberekAssignmentDTO { CyberekId = 1 };
            var user = new ApplicationUser { UserName = "testuser" };
            ...
            await Assert.ThrowsAsync<InvalidOperationException>(() =>
                _validationService.ValidateCyberekAssignmentAsync("testuser", assignmentDto));
        }
        ...
        public async Task ValidateGiftAssignmentAsync_WithEmptyUserName_ReturnsValidationError()
        {
            ...
            // Act
            var result = await _validationService.ValidateGiftAssignmentAsync("", giftDto);
        ...
        [Fact]
        public async Task ValidateGiftAssignmentAsync_WithNullDto_ReturnsValidationError()
        {
            // Act
            var result = await _validationService.ValidateGiftAssignmentAsync("testuser", null!);
        ...
        [Fact]
        public async Task ValidateGiftAssignmentAsync_WithInvalidGiftedCyberekId_ReturnsValidationError()
        {
            // Arrange
        ...
        public async Task ValidateGiftAssignmentAsync_WithRepositoryException_PropagatesException()
        {
            ...
            // Act & Assert
            await Assert.ThrowsAsync<InvalidOperationException>(() =>
                _validationService.ValidateGiftAssignmentAsync("testuser", giftDto));
        }
