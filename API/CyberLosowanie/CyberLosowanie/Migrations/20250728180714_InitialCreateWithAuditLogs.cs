...
{
    /// <inheritdoc />
    public partial class InitialCreateWithAuditLogs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "[1,2,6]", 0, "https://randomuser.me/api/portraits/men/1.jpg", "Michał", "Majewski" },
                    { 2, "[1,2,10]", 0, "https://randomuser.me/api/portraits/women/2.jpg", "Kornelia", "Majewska" },
                    { 3, "[3,9,11]", 0, "https://randomuser.me/api/portraits/women/3.jpg", "Ola", "Sudoł" },
                    { 4, "[2,4,11]", 0, "https://randomuser.me/api/portraits/women/4.jpg", "Daria", "Kurowska" },
                    { 5, "[5,7,8]", 0, "https://randomuser.me/api/portraits/women/5.jpg", "Asia", "Małek" },
                    { 6, "[5,6,12]", 0, "https://randomuser.me/api/portraits/men/6.jpg", "Filip", "Wilczyński" },
                    { 7, "[3,7,10]", 0, "https://randomuser.me/api/portraits/men/7.jpg", "Marek", "Grabowski" },
                    { 8, "[1,5,8]", 0, "https://randomuser.me/api/portraits/men/8.jpg", "Michał", "Karbowiak" },
